...
저장된 진료기록의 X-Ray 이미지를 AI 모델에 입력하여 폐렴 예측 결과를 생성하고, 생성된 예측 결과를 조회할 수 있는 API를 설계한다.
...
| --- | --- | --- | --- |
| REQ-PRED-001 | AI 모델 활용 폐렴 예측 | POST | `/api/v1/medical-records/{record_id}/predict` |
| REQ-PRED-002 | AI 모델 활용 폐렴 예측 결과 조회 | GET | `/api/v1/medical-records/{record_id}/analyses` |

## 4. AI 모델 활용 폐렴 예측 API
